...
class UserIntegrationTest {
    ...
    void update_user_success() throws Exception {
        // given
        UserDto savedUser = userService.create(new CreateUserRequestDto("oldUser", "old@test.com", "pass1234", null));
        em.flush();
        em.clear();
        ...
        em.flush();
        em.clear();
        User updatedUser = userRepository.findById(savedUser.id()).orElseThrow();
    ...
    void delete_user_success() throws Exception {
        // given
        UserDto savedUser = userService.create(new CreateUserRequestDto("delUser", "del@test.com", "pass1234", null));
        em.flush();
        em.clear();
